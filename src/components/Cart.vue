<template>
  ...
  <div class="flex gap-10 mb-1 pt-7 justify-center">
    <div class="bg-white rounded-md border-[#000000] border-2 drop-shadow-lg p-6 w-96 text-center">
      <img src="../assets/hamburger.jpg" alt="Hamburger" class="w-96 h-96 border-2 border-black">
 ...
 <div class="bg-white rounded-md border-[#000000] border-2 drop-shadow-lg p-6 w-96 text-center">
  <img src="../assets/pepsi.jpg" alt="Pepsi" class="w-96 h-96 border-2 border-black">
    ...
    <div class="mt-36 text-center mb-5">
      ...
      <div class="flex justify-center gap-12">
        <div 
          ...
          <img src="../assets/card.png" alt="Bankkártya" class="w-64 h-64 mx-auto">
        ...
        <div 
          ...
          <img src="../assets/cash.png" alt="Készpénz" class="w-64 h-64 mx-auto">
...
const trackStyle = computed(() => {
  const itemWidth = 140; 
  const trackOffset = (itemWidth * selectedIndex.value) + (selectedIndex.value * 20); 
